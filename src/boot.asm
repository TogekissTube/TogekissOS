...
[bits 16]   ; Indica que el código es de 16 bits


org 0x7C00  ; Dirección de arranque del gestor

start:
    jmp main  ; Salta a la etiqueta main

main:
    mov ah, 0x0E        ; Función de impresión del BIOS
    mov al, 'L'         ; Carácter 'L'
    int 0x10            ; Llama a la interrupción del BIOS para imprimir el carácter
